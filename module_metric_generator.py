...
def insert_metric(module_name, metric_name, metric, db):
...
if __name__ == '__main__':
    ...
    for module_name, info in modules.items():
        ...
        logging.info("Dropping all documents inside collection " + module_name)
        db[module_name].drop()
        ...
        for metric_name, calculator in calculators.items():
            ...
            insert_metric(module_name, metric_name, metric, db)
